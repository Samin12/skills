...
license: MIT
metadata:
  hermes-tags: "design, design-system, tokens, ui, accessibility, wcag, tailwind, dtcg, google"
  hermes-related_skills: "popular-web-designs, claude-design, excalidraw, architecture-diagram"
  version: 1.1.0
  author: Hermes Agent
