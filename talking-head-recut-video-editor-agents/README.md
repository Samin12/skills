...
# talking-head-recut-video-editor-agents
...
Ask your agent to use `$talking-head-recut-video-editor-agents`, or have it read [SKILL.md](./SKILL.md) before starting the task.
