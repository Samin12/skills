...
license: MIT
metadata:
  hermes-tags: "maps, geocoding, places, routing, distance, directions, nearby, location, openstreetmap, nominatim, overpass, osrm"
  hermes-category: productivity
  hermes-requires_toolsets: terminal
  hermes-supersedes: find-nearby
  version: 1.2.0
  author: Mibayy
