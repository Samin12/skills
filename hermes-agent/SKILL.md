...
license: MIT
metadata:
  hermes-tags: "hermes, setup, configuration, multi-agent, spawning, cli, gateway, themes, skins, desktop-plugins, tui-widgets, petdex, development"
  hermes-homepage: "https://github.com/NousResearch/hermes-agent"
  hermes-related_skills: "claude-code, codex, opencode"
  version: 3.1.0
