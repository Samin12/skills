...
license: MIT
metadata:
  hermes-tags: "Google, Gmail, Calendar, Drive, Sheets, Docs, Contacts, Email, OAuth"
  hermes-homepage: "https://github.com/NousResearch/hermes-agent"
  hermes-related_skills: himalaya
  version: 1.2.0
  author: Nous Research
  platforms: "linux, macos, windows"
  required_credential_files: "{\"description\": \"Google OAuth2 client credentials (downloaded from Google Cloud Console)\"}"
---
# Google Workspace
