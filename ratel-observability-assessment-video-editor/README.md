...
# ratel-observability-assessment-video-editor
...
Ask your agent to use `$ratel-observability-assessment-video-editor`, or have it read [SKILL.md](./SKILL.md) before starting the task.
