...
license: MIT
metadata:
  hermes-tags: "twitter, x, social-media, xurl, official-api"
  hermes-homepage: "https://github.com/xdevplatform/xurl"
  hermes-upstream_skill: "https://github.com/openclaw/openclaw/blob/main/skills/xurl/SKILL.md"
  version: 1.1.3
